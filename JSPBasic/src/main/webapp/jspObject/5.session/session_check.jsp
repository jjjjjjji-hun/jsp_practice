...
<%
	/*
		- 세션에 저장된 데이터는 브라우저 창이 종료될 때까지, 혹은 세션의 
		  유효시간이 만료되지 전까지 웹어플리케이션의 모든 JSP페이지에서 사용할 수 있습니다.
		  
		- 세션의 저장된 데이터를 가져오려면 session 객체의 getAttribute() 메서드를
		  사용하며, 매가값으로 가져올 데이터의 세션 이름을 적어줍니다.
	*/
	...
	// 기본 시간은 30분으로 세팅되어있고(티폴트) 바꾼다면 초단위로 바꿀 수 있습니다.
	...
	if(request.isRequestedSessionIdValid()){
		...
		out.println("세션이 파기되어 조회 할 수 없습니다.<br/>");
	}
	out.println("------------<br/>");
