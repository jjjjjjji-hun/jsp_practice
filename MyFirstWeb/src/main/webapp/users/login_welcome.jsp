...
<%
	...
	// 로그인 안 된 사용자가 여기로 접근하면 로그인 페이지로 보내주세요.
	if(seId == null){
...
<body>
	<h1><%=seId %>님 로그인을 환영합니다.</h1>
	<a href="login_update.jsp">정보수정하기</a><br/>
	<a href="logout.jsp">로그아웃하기</a><br/><!-- 세션 파기 후 login_form.jsp로 보내주세요
	login_form.jsp도 만약 로그인한 사용자가 접근하면 welcome페이지로 보내도록 로직을 수정해주세요. -->
	<a href="member_out.jsp">회원탈퇴하기</a><!-- 회원 탈퇴를 위해 member_out.jsp를 만들어보겠습니다. -->
</body>
</html>