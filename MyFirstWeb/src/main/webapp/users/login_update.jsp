...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	// 1. 세션에서 아이디를 얻어와 변수에 저장합니다. 세션 결과값이 null 이면 login_form.jsp로 이동
	...
	try{
		...
		// 혹시나 데이터가 안들어왔을 상황을 대비해 rs.next()는 if문의 조건절에 넣어서 실행하는 것이 좋습니다.
		if(rs.next()){
...
<body>
	...
	보통 정보 수정을 하는 경우는, 미리 회원정보가 form에 가입되어 있는 경우가 많습니다.
